...
class SiamUnet_conc(nn.Module):
    ...
    def __init__(self, input_nbr, label_nbr):
        ...
        self.upconv16_11 = nn.ConvTranspose2d(128, 32, kernel_size=3, padding=1, stride=4, output_padding=3)
        self.upconv16_12 = nn.ConvTranspose2d(32, 6, kernel_size=3, padding=1, stride=4, output_padding=3)
        self.upconv16_21 = nn.ConvTranspose2d(128, 32, kernel_size=3, padding=1, stride=4, output_padding=3)
        self.upconv16_22 = nn.ConvTranspose2d(32, 6, kernel_size=3, padding=1, stride=4, output_padding=3)

        self.sm = nn.LogSoftmax(dim=1)

        self.head = nn.Sequential(conv3x3(128, 32, lightweight=False),
                                  nn.BatchNorm2d(32),
                                  nn.ReLU(True),
                                  nn.Dropout(0.1, False),
                                  nn.Conv2d(32, 6, 1, bias=True))
    ...
    def forward(self, x1, x2, tta = False):
        ...
        # out1 = torch.sigmoid(self.upconv16_12(self.upconv16_11(x4p1)))
        # out2 = torch.sigmoid(self.upconv16_22(self.upconv16_21(x4p2)))
